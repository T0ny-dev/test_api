    ...
    <div>
      {
        ...
        <form className='Container' onSubmit={handleSubmit}>
          ...
          <input  role="nputDiscord" id="discordid1" type="text" placeholder="Enter id discord" name="id-discord" required value={discordId1} onChange={(e)=> setdiscordId(e.target.value)}></input>
